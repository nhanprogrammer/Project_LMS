...
namespace Project_LMS.Interfaces
{
    public interface INotificationsService
    {
        ...
        Task<ApiResponse<bool>> SendClassNotificationAsync(int senderUserId, int classId, string subject, string content, bool? type = false);
        Task<ApiResponse<bool>> SendUserListNotificationAsync(int senderUserId, List<int> userIds, string subject, string content, bool? type = false);
    }
}