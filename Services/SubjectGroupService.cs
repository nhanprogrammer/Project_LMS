...
)
{
    ...
    {
        var subjectGroup = _mapper.Map<SubjectsGroup>(createSubjectGroupRequest);
...
public async Task<ApiResponse<SubjectGroupResponse>> UpdateSubjectGroupAsync(int id, UpdateSubjectGroupRequest updateSubjectGroupRequest)
{
    ...
    var subjectsToAdd = subjectIds.Except(currentSubjectIds)
    ...
    {
        var existingSubjectGroupSubject = await _context.SubjectGroupsSubjects
    ...
    {
        _context.SubjectGroupsSubjects.RemoveRange(subjectsToRemove);
    }
    ...
    {
        var subjectsToRemove = await _context.SubjectGroupsSubjects
