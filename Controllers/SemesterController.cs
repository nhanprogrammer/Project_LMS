...
namespace Project_LMS.Controllers
{
    ...
    public class SemesterController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResponse<SemesterResponse>>> Create(SemesterRequest semesterRequest)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<ApiResponse<SemesterResponse>>> Update(int id, SemesterRequest semesterRequest)
        {
            try
            {
                var jsonString = semesterRequest?.ToString();
